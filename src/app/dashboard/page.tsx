      ...
      <div className="border-b border-white/5 backdrop-blur-sm sticky top-0 z-50 bg-black/80">
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-6 flex items-center justify-between">
          <div className="space-y-1">
            <p className="text-[10px] text-white/30 font-black uppercase tracking-[0.2em]">Welcome back</p>
            <h1 className="text-4xl md:text-5xl font-light text-white lowercase tracking-tight">{profile.full_name || 'Dashboard'}</h1>
          </div>
