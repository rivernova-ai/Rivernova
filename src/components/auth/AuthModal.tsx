...
export function AuthModal({ open, onOpenChange }: AuthModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px] bg-[#0c0c10] border-white/10 text-white rounded-3xl shadow-2xl">
        ...
        <DialogHeader className="pt-6 pb-2 text-center flex flex-col items-center">
          <div className="mb-4 w-12 h-12 flex items-center justify-center text-white drop-shadow-[0_0_10px_rgba(99,102,241,0.6)]">
        ...
        <div className="grid gap-6 py-4">
          ...
          <Button 
            ...
            disabled={loading}
            className="w-full bg-white/5 border-white/10 hover:bg-white/10 text-white h-12 rounded-xl"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#0c0c10] px-2 text-white/40">Or continue with</span>
            </div>
          </div>
