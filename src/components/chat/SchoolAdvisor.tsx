...
Format this as a strategic briefing with bold headers. Reference this student's specific profile, not generic advice. After writing the briefing, call the report_metrics tool with your honest scores (0–100) for safety, social, local, and roi.`;
