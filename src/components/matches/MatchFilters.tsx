      ...
      <div className="relative">
        <button
          ...
          className={`w-full group relative overflow-hidden rounded-2xl px-4 py-3.5 text-left transition-all duration-300 ${
            isOpen 
              ? `bg-gradient-to-br ${color} shadow-lg border-2` 
                ...
                <div className="p-2 space-y-1 max-h-[300px] overflow-y-auto">
                  {options.map((option) => (
                    <button
                      ...
                      className={`w-full group/item relative overflow-hidden rounded-xl px-4 py-3 text-left transition-all duration-200 cursor-pointer ${
                        value === option.value
                    ...
                    >
                      ...
                      {value !== option.value && (
                        <div className={`absolute inset-0 bg-gradient-to-r ${color} opacity-0 group-hover/item:opacity-10 transition-opacity duration-300 pointer-events-none`} />
                      )}
                    </button>
                  ))}
                </div>
